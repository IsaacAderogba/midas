        ...
        <body>
          <div style="text-align: center;">
            ...
            <div style="margin: 16px;">
                <a style="color:#4551B5; font-size: 16px;" href="${process.env.DOMAIN}/invite/${invitedUser.email}/${invitedUser.role}/${invitedUser.workspaceUserId}/${invitedUser.workspaceId}">Accept Invite</a>
            </div>
          </div>
        </body>
      </html>
